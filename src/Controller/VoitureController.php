...
class VoitureController extends AbstractController
{
    ...
    {
        // Supposons que tu reçois la destination depuis une requête ou que tu l'initialises
        $destination = $request->query->get('destination', 'Abidjan'); // Par exemple, obtenir la destination depuis les paramètres de requête

        return $this->render('voiture/index.html.twig', [
            'voitures' => $voitureRepository->findAll(),
            'destination' => $destination, // Passe la variable destination à la vue
        ]);
    }
    ...
    {
        $voiture = new Voiture();
        $form = $this->createForm(VoitureType::class, $voiture); // Assurez-vous que le type de formulaire s'appelle VoitureType
