...
Ajouter, modifier, supprimer, Voir rapidement les informations d’un client

- Gestion des Chauffeurs

CRUD complet, Suivi des chauffeurs disponibles

- Gestion des Voitures
  
CRUD complet sur les véhicules, Gestion de la disponibilité, Gestion des caractéristiques et de la marque
